<?php
/**
 * Description of VietnameseUtils
 *
 * @version 1.0
 * @since 1 Nov 2011
...
class VietnameseUtils extends \yii\base\Component {
    //put your code here
    ...
    public static function removeSigns($str) {
        return str_replace(array_merge(VietnameseUtils::$_vi_lower, VietnameseUtils::$_vi_upper), array_merge(VietnameseUtils::$_vi_lower_nosigns, VietnameseUtils::$_vi_upper_nosigns), $str);
    }
    ...
    public static function removeSigns2($str) {
        $patterns = array();
        $replacements = array();
        foreach (VietnameseUtils::$_viet_char2 as $res=>$source) {
            $patterns[] = "/$source/";
            $replacements[] = $res;
        }
    ...
    public static function toLower($str) {
        return str_replace(VietnameseUtils::$_vi_all_upper, VietnameseUtils::$_vi_all_lower, $str);        
    }
    ...
    public static function toUpper($str) {
        return str_replace(VietnameseUtils::$_vi_all_lower, VietnameseUtils::$_vi_all_upper, $str);          
    }
    ...
    public static function properName($str) {
        $str = ' '.VietnameseUtils::proper(VietnameseUtils::toLower($str));
    ...
    public static function hasSigns($str) {
        $pattern = join(array_merge(VietnameseUtils::$_vi_lower, VietnameseUtils::$_vi_upper));
        //return $pattern;
    ...
    public static function lettersOnly($str) {
        $pattern = join(array_merge(VietnameseUtils::$_en_lower, VietnameseUtils::$_en_upper, VietnameseUtils::$_vi_lower, VietnameseUtils::$_vi_upper));
        $pattern = "/[^\s$pattern]/";
        //return $pattern;
    ...
    public static function makeSearchableStr($str) {
        $str = VietnameseUtils::removeSigns($str);
        $str = strtolower($str);

        $pattern = join(array_merge(VietnameseUtils::$_en_lower));
        $pattern = "/[^\s${pattern}1234567890]/";
        //return $pattern;
        $str = preg_replace($pattern, '', $str);
        return VietnameseUtils::proper($str);
    ...
    public static function makeCodeName($str, $addRandomToken = false) {
        ...
        //return $pattern;
        $str = preg_replace($pattern, '', $str);
        //return implode('_',explode(' ',  VietnameseUtils::proper($str)));
        $result =  str_replace(" ", "_", VietnameseUtils::proper($str));
        if($addRandomToken){
